...
export type CommentModelKeySpecifier = ('application_id' | 'author' | 'body' | 'created_at' | 'id' | 'parent_id' | 'ratings' | 'replied_to_id' | 'replied_to_user' | 'replies' | 'thread_id' | 'updated_at' | 'user_id' | CommentModelKeySpecifier)[];
